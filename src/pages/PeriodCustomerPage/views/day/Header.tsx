      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between sm:gap-6">
              ...
              <>
                ...
                <div className="mt-2 flex items-center gap-3 text-xs sm:text-sm text-gray-700 dark:text-gray-300">
                  {(() => {
                    ...
                    if (patternId) {
                      const isRest =
                        pattern?.pattern_type === "rest_day" ||
                        pattern?.rest_day === true;
                      const workout = pattern?.workout_timing as
                        | {
                      ...
                      return (
                        <div className="flex items-center gap-2">
                          ...
                          {isRest && (
                            <span className="px-2 py-0.5 rounded bg-yellow-100 dark:bg-yellow-800 text-yellow-700 dark:text-yellow-200">
                              Día de descanso
                            </span>
                          )}
                          ...
                          {workout && (
                            <div className="flex items-center gap-2">
                              {workout.workout_time && (
                                <span className="px-2 py-0.5 rounded bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300">
                                  Hora: {workout.workout_time}
                                </span>
                              )}
                              {typeof workout.duration_minutes === "number" && (
                                <span className="px-2 py-0.5 rounded bg-blue-50 dark:bg-blue-900/20">
                    ...
                    if (trainingDay === true) {
                      return (
                        <div className="flex items-center gap-2">
                          ...
                          <span className="px-2 py-0.5 rounded bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300">
                            Día configurado (sin rutina) —{" "}
                    ...
                    if (trainingDay === false) {
                      return (
                        <div className="flex items-center gap-2">
                          ...
                          <span className="px-2 py-0.5 rounded bg-gray-100 dark:bg-gray-800">
                            Día configurado (sin rutina) — Día de descanso
                          </span>
                        </div>
                      );
                    }
                    ...
                    return (
                      <div className="text-sm text-gray-500 dark:text-gray-400">
                        No hay configuración de entrenamiento para este día
                      </div>
                    );
                  })()}
                </div>
        ...
        <div className="min-w-[180px] bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded p-3">
          ...
          <div className="text-xl font-bold text-indigo-600 dark:text-indigo-400">
            {dayData.compliance.overall.toFixed(1)}%
          </div>
        </div>
        ...
        <div className="min-w-[180px] bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded p-3">
          {(() => {
            ...
            const net =
              dii && typeof dii.balance_neto === "number"
                ? dii.balance_neto
                : null;
            ...
            const getCategory = (value: number | null) => {
              ...
              if (value < thresholds.p25)
                return {
                  label: "Fuerte antiinf",
                  badge:
                    "bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300",
                  color: "text-green-600 dark:text-green-400",
                };
              if (value >= thresholds.p25 && value < thresholds.median)
                return {
                  label: "Moderada antiinf",
                  badge:
                    "bg-teal-50 dark:bg-teal-900/20 text-teal-700 dark:text-teal-300",
                  color: "text-teal-600 dark:text-teal-400",
                };
              if (value >= thresholds.median && value < thresholds.p75)
                return {
                  label: "Neutro",
                  badge:
              ...
              if (value >= thresholds.p75 && value < thresholds.p90)
                return {
                  label: "Moderada proinf",
                  badge:
            ...
            return (
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div
                    className={`text-xl font-bold ${category ? category.color : "text-gray-700 dark:text-gray-300"}`}
                  >
                    {net !== null ? net.toFixed(2) : "N/A"}
                  </div>
                </div>
