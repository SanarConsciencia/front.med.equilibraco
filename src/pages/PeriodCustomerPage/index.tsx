      ...
      <div className="w-full h-screen flex flex-col bg-gray-900 text-gray-100">
        ...
        {!isLoading && !error && complianceData && (
          <div className="flex-1 flex overflow-hidden relative">
            ...
            {/* Left Sidebar - Icon Bar - hidden on mobile */}
            ...
            {leftSidebarExpanded && (
              <div className="fixed inset-y-0 left-0 z-30 w-72 h-full overflow-hidden lg:relative lg:inset-auto lg:z-auto lg:w-auto lg:h-auto lg:overflow-visible">
                <ExplorerPanel
                  tabs={tabs}
            ...
            <div className="flex-1 flex flex-col min-w-0">
              {/* Mobile menu bar */}
              <div className="lg:hidden flex items-center gap-2 px-3 py-2 bg-gray-800 border-b border-gray-700 shrink-0">
                <button
              ...
              <div
                ...
                onMouseDown={(e) => {
                  ...
                  const onMouseMove = (ev: MouseEvent) => {
                    ...
                    const newHeight = Math.max(
                      100,
                      Math.min(window.innerHeight - 150, startHeight - deltaY),
                    );
                ...
                className={`hidden lg:flex h-2 ${isResizing ? "bg-blue-500" : "bg-gray-200 dark:bg-gray-700"} cursor-row-resize items-center justify-center`}
              >
